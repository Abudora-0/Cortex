  ...
  return (
    <div className="space-y-4">
      ...
      <ol className="ml-4 list-decimal space-y-1 text-xs leading-relaxed text-ink-soft">
        ...
        <li>
          Click the <b>UniHub Sync</b> bookmark — it reads your results and sends them
